...
This takes a camera and turns it into an off-axis-projection camera. I.e. it creates an asymmetric
view frustum that is determned by the user's head position and direction.
